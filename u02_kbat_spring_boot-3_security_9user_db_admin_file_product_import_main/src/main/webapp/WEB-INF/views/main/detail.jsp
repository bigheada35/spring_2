    ...
    <div class="col-sm-4 bg-white">
            ...
            <div class="card-body">
              ...
              <div class="d-grid gap-2">
              	<a href="/main/playVideo?product_id=${prod.product_id}" class="btn btn-primary my-3">장바구니담기</a>
              	<a href="/main/playVideo?product_id=${prod.product_id}" class="btn btn-primary my-3">구매하기</a>
              	<a href="/main/playVideo?product_id=${prod.product_id}" class="btn btn-primary my-3">Play</a>
              </div>
            </div>
    </div>
  </div>
