			...
			<div class="row">
				...
				<div class="col-md-3 contact-info" align="center">
					<div class="single-info" style="margin-bottom: 40px">
						...
						<hr>
						<h5>
							<a href="${pageContext.request.contextPath}/member/mypage/order">주문내역
								조회</a>
						</h5>
						<h5>
							<a
					...
					<div class="single-info" style="margin-bottom: 40px">
						...
						<h5>
							<a
								href="${pageContext.request.contextPath}/member/mypage/review/list">구매후기</a>
						</h5>
						<h5>
							<a
							...
							<div class="row">
								<div class="col-md-3 thumbnail" align="center">
									<a
										...
										src="<c:url value="/prdct_img/prdct_thumbnail/${order.prdct_thumbnail}"/>"
								...
								<div class="col-md-4" align="right"
									...
									<c:choose>
										<c:when test="${order.order_state_number eq 1}">
											...
											<button type="button" class="btn btn-primary btn"
												data-toggle="modal" data-target="#mdal">배송조회</button>&nbsp;
										<button type="button" class="btn btn-danger btn"
												onclick="location.href='${pageContext.request.contextPath}/'">주문취소</button>
										</c:when>
										...
										<c:when test="${order.order_state_number eq 6}">
											...
											<button type="button" class="btn btn-primary btn"
												data-toggle="modal" data-target="#mdal">배송조회</button>&nbsp;
										<button type="button"
												class="btn btn-success btn prdconfirm${order.order_number}"
												data-rno="${order.order_number}">주문확정</button>
											<br>
											<button type="button" class="btn btn-danger btn"
												onclick="location.href='${pageContext.request.contextPath}/'">교환요청</button>&nbsp;
										<button type="button" class="btn btn-danger btn"
												onclick="location.href='${pageContext.request.contextPath}/'">환불요청</button>
																									...
																									.ajax({
																										...
																										success : function(
																											...
																											console
																													.log(result);
																											console
																													.log("PRDCT_STATE_CHANGED!");
																											$(
																													location)
																													.attr(
																															'href',
																															'${pageContext.request.contextPath}/member/mypage');
																										},
																										error : function(
																												e) {
																											console
										...
										<c:when test="${order.order_state_number eq 7}">
											<h4>주문확정</h4>
											<button type="button" class="btn btn-primary btn"
												onclick="window.location.href='${pageContext.request.contextPath}/member/mypage/review/${order.prdct_id}/write'">리뷰쓰기</button>&nbsp;
										<button type="button" class="btn btn-danger btn"
												onclick="location.href='${pageContext.request.contextPath}/'">교환요청</button>
											<br>
											<button type="button" class="btn btn-danger btn"
										...
										<c:when test="${order.order_state_number eq 8}">
											<h4>주문취소</h4>
											<button type="button" class="btn btn-primary btn"
												onclick="location.href='${pageContext.request.contextPath}/'">주문취소조회</button>
										</c:when>
										<c:when test="${order.order_state_number eq 9}">
											<h4>교환요청</h4>
											<button type="button" class="btn btn-primary btn"
												onclick="location.href='${pageContext.request.contextPath}/'">교환조회</button>
										</c:when>
										<c:when test="${order.order_state_number eq 10}">
											<h4>환불요청</h4>
											<button type="button" class="btn btn-primary btn"
												onclick="location.href='${pageContext.request.contextPath}/'">환불조회</button>
										</c:when>
										<c:otherwise>
											<h4>환불완료</h4>
										</c:otherwise>
									...
									<%-- 모달 영역 --%>
									<div class="modal fade myModal" id="mdal" tabindex="-1"
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														<label id="tekbeCompnayName">택배회사명</label> <select
															id="tekbeCompnayList" class="form-control"
															name="tekbeCompnayList"></select>
													</div>
													<div>
														<label id="tekbeCompnayName">운송장번호</label> <input
															type="text" id="invoiceNumberText" class="form-control"
															name="invoiceNumberText"><br />
														<br />
													</div>
													<button id="myButton1" class="btn btn-primary">택배
														조회하기</button>
													<br />
													<br />
													<div>
							...
							<c:forEach items="${view_list}" var="watch" end="2">
								<div class="col-md-4 thumbnail" align="center">
									<div>
										...
										<a
											href="${pageContext.request.contextPath}/prdct/${watch.prdct_id}"><img
											src="<c:url value="/prdct_img/prdct_thumbnail/${watch.prdct_thumbnail}"/>"
											onerror="this.src='/prdct_img/prdct_thumbnail/none-thumbnail.png'"
											width="150px" height="200px"></a>
									</div>
							...
							<c:forEach items="${like_prdct_list}" var="like" end="2">
								<div class="col-md-4 thumbnail" align="center">
									<div>
										<!-- 경로 prdct_img/prdct_thumbnail로 바뀌면 수정하자... -->
										<a
											href="${pageContext.request.contextPath}/prdct/${like.prdct_id}"><img
											src="<c:url value="/prdct_img/prdct_thumbnail/${like.prdct_thumbnail}"/>"
											onerror="this.src='/prdct_img/prdct_thumbnail/none-thumbnail.png'"
											width="150px" height="200px"></a>
									</div>
									<div style="padding-top: 3%">
