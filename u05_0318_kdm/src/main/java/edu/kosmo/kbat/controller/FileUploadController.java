...
public class FileUploadController {
	...
	public String listUploadedFiles2(Model model) throws IOException {
		...
		while (itr.hasNext()) {
			...
			String uri = MvcUriComponentsBuilder.fromMethodName(FileUploadController.class, "serveFile", fname).build()
					.toUri().toString();
	...
	public String handleFileUpload(@RequestParam("fileVideo") MultipartFile file1,
			@RequestParam("fileImage") MultipartFile file2, RedirectAttributes redirectAttributes,
		...
		String uri1 = MvcUriComponentsBuilder
				.fromMethodName(FileUploadController.class, "serveFile", file1.getOriginalFilename()).build().toUri()
				.toString();

		String uri2 = MvcUriComponentsBuilder
				.fromMethodName(FileUploadController.class, "serveFile", file2.getOriginalFilename()).build().toUri()
				.toString();
